                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('2fa') }}">
                        ...
                        <div class="form-group">
                            <p>Por favor ingrese el <strong>OTP</strong> generado en su aplicación de autenticación. 
                            <br> Asegúrese de enviar el actual ya que se actualiza cada 30 segundos.</p>
                            <label for="one_time_password" class="col-md-4 control-label">Contraseña única</label>
